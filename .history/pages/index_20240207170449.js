      ...
      <main className={`${styles.main} ${inter.className}`}>
        <div className={`${layout['row']}`}>
          <div className={`${layout['col-lg-4']} ${layout['col-md-4']} ${layout['col-lg-4']}}`}>
            <div key={-1} className={styles['aside-containera']}>
              <button key={-1} onClick={() => setCate("")} >All</button>
              {
          ...
          <div className={`${layout['col-lg-8']} ${layout['col-md-8']} ${layout['col-lg-8']}}`}>
            <div className={styles['main-content-containera']}>
              ...
              {
                data && data.filter((product) => (product.category == cate || cate == null)).map((product, index) => {
                  return (
                    <>
                      <Product
                        index={index}
